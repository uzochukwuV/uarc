...
export interface TaskLogicV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "actionRegistry"
      | "executeTask"
...
export interface TaskLogicV2 extends BaseContract {
  connect(runner?: ContractRunner | null): TaskLogicV2;
  waitForDeployment(): Promise<this>;

  interface: TaskLogicV2Interface;
