...
export interface ITaskLogicInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "actionRegistry"
      | "conditionOracle"
...
export interface ITaskLogic extends BaseContract {
  connect(runner?: ContractRunner | null): ITaskLogic;
  waitForDeployment(): Promise<this>;

  interface: ITaskLogicInterface;
