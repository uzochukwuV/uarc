...
export interface ITaskVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "creator"
      | "depositNative"
...
export interface ITaskVault extends BaseContract {
  connect(runner?: ContractRunner | null): ITaskVault;
  waitForDeployment(): Promise<this>;

  interface: ITaskVaultInterface;
