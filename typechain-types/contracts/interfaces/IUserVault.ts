...
export interface IUserVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "cancelAutomation"
      | "createAutomation"
...
export interface IUserVault extends BaseContract {
  connect(runner?: ContractRunner | null): IUserVault;
  waitForDeployment(): Promise<this>;

  interface: IUserVaultInterface;
