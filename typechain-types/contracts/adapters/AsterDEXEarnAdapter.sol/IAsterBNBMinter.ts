...
export interface IAsterBNBMinterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "claimWithdraw"
      | "convertToAssets"
  ...
  encodeFunctionData(
    functionFragment: "depositBNBFor",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface IAsterBNBMinter extends BaseContract {
  connect(runner?: ContractRunner | null): IAsterBNBMinter;
  waitForDeployment(): Promise<this>;

  interface: IAsterBNBMinterInterface;
  ...
  depositBNB: TypedContractMethod<[], [bigint], "payable">;

  depositBNBFor: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "depositBNB"
  ): TypedContractMethod<[], [bigint], "payable">;
  getFunction(
    nameOrSignature: "depositBNBFor"
