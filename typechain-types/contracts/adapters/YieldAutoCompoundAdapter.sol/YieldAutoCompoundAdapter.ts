...
export declare namespace YieldAutoCompoundAdapter {
  export type CompoundParamsStruct = {
    yieldVault: AddressLike;
    rewardDistributor: AddressLike;
    rewardToken: AddressLike;
    baseAsset: AddressLike;
    swapPoolFee: BigNumberish;
    minRewardAmount: BigNumberish;
    minAmountOut: BigNumberish;
    compoundInterval: BigNumberish;
    lastCompoundTime: BigNumberish;
    recipient: AddressLike;
  };

  export type CompoundParamsStructOutput = [
    yieldVault: string,
...
export interface YieldAutoCompoundAdapterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_SLIPPAGE"
      | "MIN_COMPOUND_INTERVAL"
      | "calculateCompoundBoost"
      | "canExecute"
      | "decodeParams"
      | "execute"
  ...
  encodeFunctionData(
    functionFragment: "MIN_COMPOUND_INTERVAL",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "calculateCompoundBoost",
  ...
  encodeFunctionData(
    functionFragment: "isWorthCompounding",
    values: [BigNumberish, BigNumberish]
  ): string;
...
export interface YieldAutoCompoundAdapter extends BaseContract {
  connect(runner?: ContractRunner | null): YieldAutoCompoundAdapter;
  waitForDeployment(): Promise<this>;

  interface: YieldAutoCompoundAdapterInterface;
  ...
  MIN_COMPOUND_INTERVAL: TypedContractMethod<[], [bigint], "view">;

  calculateCompoundBoost: TypedContractMethod<
    [baseAPY: BigNumberish, compoundsPerYear: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  decodeParams: TypedContractMethod<
    [params: BytesLike],
    [YieldAutoCompoundAdapter.CompoundParamsStructOutput],
    "view"
  >;
  ...
  isWorthCompounding: TypedContractMethod<
    [gasPrice: BigNumberish, rewardValue: BigNumberish],
    [
      [boolean, bigint] & {
        worthCompounding: boolean;
  ...
  getFunction(
    nameOrSignature: "MIN_COMPOUND_INTERVAL"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "calculateCompoundBoost"
  ): TypedContractMethod<
    [baseAPY: BigNumberish, compoundsPerYear: BigNumberish],
    [bigint],
    "view"
  ...
  getFunction(
    nameOrSignature: "isWorthCompounding"
  ): TypedContractMethod<
    [gasPrice: BigNumberish, rewardValue: BigNumberish],
    [
      [boolean, bigint] & {
