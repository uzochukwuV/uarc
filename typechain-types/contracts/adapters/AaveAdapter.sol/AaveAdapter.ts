...
export interface AaveAdapterInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "batchAddPools",
    values: [AddressLike[]]
  ): string;
  encodeFunctionData(
...
export interface AaveAdapter extends BaseContract {
  ...
  batchAddPools: TypedContractMethod<
    [pools: AddressLike[]],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "batchAddPools"
  ): TypedContractMethod<[pools: AddressLike[]], [void], "nonpayable">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "supportedPools"
